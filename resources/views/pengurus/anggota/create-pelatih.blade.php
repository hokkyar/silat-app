...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Tambah Pelatih</div>
            </div>
        </div>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Tambah Pelatih</h4>
                </div>
                <form id="form-data" action="{{ route('anggota.store') . '?j=pelatih' }}" method="POST"
    ...
    <script>
        function sendData() {
            ...
            if (nama != '' && tempat_lahir != '' && tanggal_lahir != '' && nomor_sertifikasi != '') {
