    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Tambah Atlet</div>
            </div>
        </div>
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Tambah Atlet</h4>
                </div>
                <form id="form-data" action="{{ route('anggota.store') . '?j=atlet' }}" method="POST"
