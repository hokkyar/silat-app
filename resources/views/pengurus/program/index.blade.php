        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Program Cabor {{ Str::title(session('cabor')->nama_cabor) }}</h4>
                    <div class="pull-right ml-auto">
                        <a href="/pengurus/kelola/program/create" class="btn btn-success btn-sm"><i class="fas fa-plus"></i>
                            Tambah Data</a>
                    </div>
                </div>
                <div class="row">
                                            ...
                                            @foreach ($all_program as $program)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="/pengurus/kelola/program/{{ $program->id }}/edit"
                                                            class="btn btn-warning btn-sm mx-1 w-25"><i
                                                                class="fa fa-pen"></i></a>
                                                        <a data-confirm-delete="true"
                                                            href="{{ route('program.destroy', $program->id) }}"
