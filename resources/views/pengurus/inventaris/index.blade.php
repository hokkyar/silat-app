        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Inventaris Cabor {{ Str::title(session('cabor')->nama_cabor) }}</h4>
                    <div class="pull-right ml-auto">
                        <a href="/pengurus/kelola/inventaris/create" class="btn btn-success btn-sm"><i
                                class="fas fa-plus"></i>
                            Tambah Data</a>
                    </div>
                </div>
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            @php
                                                $i = 1;
                                            @endphp
                                            @foreach ($all_inventaris as $inventaris)
                                                <tr>
                                                    <td>{{ $i++ }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="/pengurus/kelola/inventaris/{{ $inventaris->id }}/edit"
                                                            class="btn btn-warning btn-sm mx-1 w-25"><i
                                                                class="fa fa-pen"></i></a>
                                                        <a data-confirm-delete="true"
                                                            href="{{ route('inventaris.destroy', $inventaris->id) }}"
