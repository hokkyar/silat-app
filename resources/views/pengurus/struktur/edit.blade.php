        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Edit Struktur</h4>
                </div>
                <form id="form-data" action="{{ route('struktur.update', $struktur->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="nama_pengurus" id="nama_pengurus" type="text" class="form-control" required
                                autocomplete="off"
                                value="{{ $errors->any() ? old('nama_pengurus') : $struktur->nama_pengurus }}">
                        </div>
                        <div class="form-group">
                            <label for="jabatan">Jabatan</label>
                            <input name="jabatan" id="jabatan" type="text" class="form-control" required
                                autocomplete="off" value="{{ $errors->any() ? old('jabatan') : $struktur->jabatan }}">
                        </div>
                    </div>
