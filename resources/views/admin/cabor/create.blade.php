        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-primary">Tambah Cabor</h4>
                </div>
                <form id="form-data" action="/admin/cabor" method="POST" class="needs-validation" novalidate="">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama_cabor">Nama Cabor</label>
                            <input name="nama_cabor" id="nama_cabor" type="text" class="form-control" required
                                autocomplete="off">
                        </div>
                    </div>
